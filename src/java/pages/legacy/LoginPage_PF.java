...
//        WebElement errorElement = WaitUtils.waitUntilVisible(loginErrorMessage, timeoutInSeconds);
...
//    }
    ...
    public LoginPage_PF enterUsername(String username) {
        usernameField.sendKeys(username);
        return this;
    }

    public LoginPage_PF enterPassword(String password) {
        passwordField.sendKeys(password);
        return this;
    }
